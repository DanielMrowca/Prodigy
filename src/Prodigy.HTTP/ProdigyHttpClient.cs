...
using Polly;
using Prodigy.HTTP.Exceptions;
using Prodigy.Models;

namespace Prodigy.HTTP
{
    public class ProdigyHttpClient : IHttpClient, IDisposable
    {
        ...
        public ProdigyHttpClient(HttpClient httpClient, HttpClientOptions options,
