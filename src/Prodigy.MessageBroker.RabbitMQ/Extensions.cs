...
using Prodigy.MessageBroker.RabbitMQ.Clients;
using Prodigy.MessageBroker.RabbitMQ.Conventions;
using Prodigy.MessageBroker.RabbitMQ.Factories;
using Prodigy.MessageBroker.RabbitMQ.Initializers;
using Prodigy.MessageBroker.RabbitMQ.Publishers;
using Prodigy.MessageBroker.RabbitMQ.Subscribers;
using Prodigy.Types;
...
namespace Prodigy.MessageBroker.RabbitMQ
{
    ...
    {
        public static IProdigyBuilder AddRabbitMQ(this IProdigyBuilder builder, RabbitMqOptions options, IJsonSerializer jsonSerializer = null,
        ...
        public static IProdigyBuilder AddRabbitMQ(this IProdigyBuilder builder, string sectionName, string connectionName = null, string prefixQueueName = null, int retriesCountOnConnectingFailed = -1)
        {
